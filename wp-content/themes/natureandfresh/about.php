...
<div id="about" class="container">
        ...
        <div class="row">
            <div class="article-offset_img col-md-6 col-xs-12 noPadding">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12 noPadding">
                        <img data-delay="900" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/about_pig.jpg">
                    </div>

                    <div class="col-md-6 col-xs-12 noPadding">
                        <img data-delay="1500" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/about_pig.jpg">
                    </div>
                    <div class="col-md-6 col-xs-12 noPadding">
                        <img data-delay="1800" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/about_tree.jpg">
                    </div>
                </div>
            </div>
            <article class="col-md-6 col-xs-12">
                <div class="article-offset_heading">
                    <h2>We’re all about growing the perfect macadamia nuts lorem ipsum.</h2>
                </div>
    ...
    <div class="container-fluid article-offset">
        <div class="row">
            <article class="col-md-6 col-xs-12">
                <div class="article-offset_heading_bottom">
                    <h2>Another title to be placed here, lorem ipsum lorem ipsum.</h2>
                </div>
            ...
            <div class="article-offset_img col-md-offset-2 col-md-4 col-xs-12 noPadding">
                <div class="row">
                    <div class="col-md-12 col-xs-12 noPadding image-box">
                        <img data-delay="300" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/about_tree.jpg">
                    </div>
                    <p>&nbsp;</p>
                    <div class="col-md-12 col-xs-12 noPadding image-box">
                        <img data-delay="600" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/about_pig.jpg">
                    </div>
                    <p>&nbsp;</p>
                    <div class="row">
                        <div class="col-md-3 col-xs-12 noPadding image-box">
                            <img data-delay="1200" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/organic_cert.png">
                        </div>
                        <div class="col-md-1 col-xs-12 noPadding image-box">&nbsp;</div>
                        <div class="col-md-3 col-xs-12 noPadding image-box">
                            <img data-delay="1500" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/organic_nzGrown.png">
                        </div>
                        <div class="col-md-1 col-xs-12 noPadding image-box">&nbsp;</div>
                        <div class="col-md-3 col-xs-12 noPadding image-box">
                            <img data-delay="1800" class="lazy-load" data-src="<?php echo get_template_directory_uri(); ?>/images/pages/organic_nzMade.png">
                        </div>
                    </div>
                </div>
            </div>
